...
def plot_path(
    ...
    ax.legend(
        loc="upper left", bbox_to_anchor=(1.02, 1), borderaxespad=0, fontsize="small"
    )
    ax.set_xlabel("X")
    ax.set_ylabel("Y")
